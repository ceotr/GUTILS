...
if __name__ == '__main__':
    raw_data_path = '/home/bcovey/live_data'
    platform = 'dal556'

    flight_files = sorted(glob.glob(os.path.join(raw_data_path, '*.sbd')))
    flightReader = GliderBDReader(flight_files)

    science_files = sorted(glob.glob(os.path.join(raw_data_path, '*.tbd')))
